    ...
    <div class="container">
        ...
        <div class="card" style="border-top: 4px solid #27ae60;">
            ...
            <form action="RegisterPatientServlet" method="post">
                ...
                <div class="group">
                    <label>Aadhaar UID (12 Digits):</label>
                    <input type="text" name="aadhaar" pattern="\d{12}" title="Must be exactly 12 digits" placeholder="000000000000" required>
                </div>
                <div class="group">
                    <label>Set Portal Username:</label>
